...
public:
    ...
    CJogo(char *nome,int cursor=0){
        ...
        //target = SDL_CreateTexture(renderer, SDL_PIXELFORMAT_RGBA8888,SDL_TEXTUREACCESS_TARGET, LARG_TELA, ALT_TELA);
        TTF_Init();
    ...
    SDL_Surface *GetSurface(char *str,PIG_Cor cor,int numFonte=0){
        return fontes[numFonte]->GetSurface(str,cor);
    }
